...
# Package managers
npm i -g onenas-code@latest        # or bun/pnpm/yarn
scoop install onenas             # Windows
choco install onenas             # Windows
brew install anomalyco/tap/onenas # macOS and Linux (recommended, always up to date)
brew install onenas              # macOS and Linux (official brew formula, updated less)
sudo pacman -S onenas            # Arch Linux (Stable)
paru -S onenas-bin               # Arch Linux (Latest from AUR)
mise use -g onenas               # Any OS
nix run nixpkgs#onenas           # or github:muhdnabil66/onenas-code for latest dev branch
```
...
onenas ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/muhdnabil66/onenas-code/releases) অথবা [onenas.ai/download](https://onenas.atlasflux.my/download) থেকে ডাউনলোড করুন।
...
1. `$onenas_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.onenas/bin` - ডিফল্ট ফলব্যাক
...
onenas এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://onenas.atlasflux.my/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে onenas কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://onenas.atlasflux.my/docs)।

### অবদান (Contributing)

আপনি যদি onenas এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### onenas এর উপর বিল্ডিং (Building on onenas)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা onenas এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "onenas" ব্যবহার করেন, উদাহরণস্বরূপ "onenas-dashboard" বা "onenas-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি onenas দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/onenas) | [X.com](https://x.com/onenas)
