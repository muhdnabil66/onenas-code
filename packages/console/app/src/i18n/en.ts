export const dict = {
  ...
  "go.title": "AtlasFlux Pro | Reliable coding models for everyone",
  "go.banner.text": "GPT 5.6 Luna gets 2× usage limits for a limited time",
  "go.meta.description":
    "AtlasFlux Pro costs RM29.90/month and provides generous usage limits with reliable access to leading coding models.",
  "go.hero.title": "Reliable coding models for everyone",
  "go.hero.body":
    "AtlasFlux Pro gives programmers reliable access to capable coding models, so you can build with powerful agents without worrying about availability.",

  "go.cta.start": "Subscribe to AtlasFlux Pro",
  "go.cta.template": "{{text}} {{price}}",
  "go.cta.text": "Subscribe to AtlasFlux Pro",
  "go.cta.price": "RM29.90/month",
  "go.cta.promo": "RM29.90/month",
  "go.pricing.body": "Use with any agent. RM29.90/month with generous usage limits. Cancel any time.",
  "go.graph.free": "Free",
  ...
  "go.testimonials.brand.go": "AtlasFlux Pro",
  "go.testimonials.handle": "@AtlasFluxAI",
  ...
  "go.problem.title": "What problem does AtlasFlux Pro solve?",
  "go.problem.body":
    "AtlasFlux Pro is a RM29.90/month subscription that provides generous limits and reliable access to capable coding models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.title": "How AtlasFlux Pro works",
  "go.how.body": "AtlasFlux Pro costs RM29.90/month and works with ONeNas Code or any compatible agent.",
  "go.how.step1.title": "Create an account",
  "go.how.step1.beforeLink": "follow the",
  "go.how.step1.link": "setup instructions",
  "go.how.step2.title": "Subscribe to AtlasFlux Pro",
  "go.how.step2.link": "RM29.90/month",
  "go.how.step2.afterLink": "with generous usage limits",
  ...
  "go.privacy.beforeExceptions":
    "AtlasFlux Pro models are hosted in the US. Providers follow a zero-retention policy and do not use your data for model training, with the",
  "go.privacy.exceptionsLink": "following exceptions",
  "go.faq.q1": "What is AtlasFlux Pro?",
  "go.faq.a1":
    "AtlasFlux Pro is a RM29.90/month subscription that gives you reliable access to capable coding models.",
  "go.faq.q2": "What models does AtlasFlux Pro include?",
  "go.faq.a2": "AtlasFlux Pro includes the models listed below, with generous limits and reliable access.",
  "go.faq.q3": "Is AtlasFlux Pro the same as Zen?",
  "go.faq.a3":
    "No. Zen is pay-as-you-go, while AtlasFlux Pro costs RM29.90/month with generous limits and reliable access to a curated model lineup.",
  "go.faq.q4": "How much does AtlasFlux Pro cost?",
  "go.faq.a4.p1.beforePricing": "AtlasFlux Pro costs",
  "go.faq.a4.p1.pricingLink": "RM29.90/month",
  "go.faq.a4.p1.afterPricing": "with generous usage limits.",
  ...
  "zen.api.error.trialEnded":
    "Free promotion has ended for {{model}}. You can continue using the model with AtlasFlux Pro - {{link}}",
  ...
  "workspace.lite.subscription.message": "You are subscribed to AtlasFlux Pro.",
  ...
  "workspace.lite.subscription.selectProvider":
    "AtlasFlux Pro models are available through your connected AtlasFlux account.",
  ...
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to AtlasFlux Pro. Only one member per workspace can subscribe.",
  "workspace.lite.promo.description":
    "AtlasFlux Pro costs RM29.90/month and provides reliable access to popular coding models with generous usage limits.",
  "workspace.lite.promo.price": "RM29.90/month",
  ...
  "workspace.lite.promo.subscribe": "Subscribe to AtlasFlux Pro",
  ...
  "workspace.referral.instructions.subscribe": "Your friend joins and subscribes to AtlasFlux Pro",
  "workspace.referral.instructions.claim": "You both get usage credit to apply toward your AtlasFlux Pro limits",
  "workspace.referral.rewards.title": "Referral rewards",
  "workspace.referral.rewards.description": "Apply available referral credits toward your AtlasFlux Pro usage.",
