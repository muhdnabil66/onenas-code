  ...
  yield* Effect.promise(async () => {
    {
      ...
      function printNextSteps() {
        ...
        prompts.outro(
          [
            ...
            "",
            "   Learn more about the GitHub agent - https://onenas.atlasflux.my/docs/github/#usage-examples",
          ].join("\n"),
        )
      }
      ...
      async function installGitHubApp() {
        ...
        async function getInstallation() {
          return await fetch(`https://onenas.atlasflux.my/api/github-app-installation?owner=${app.owner}&repo=${app.repo}`)
            .then((res) => res.json())
...
export const githubRun = Effect.fn("Cli.github.run")(function* (args: { event?: string; token?: string }) {
  ...
  yield* Effect.promise(async () => {
    ...
    const shareBaseUrl = isMock ? "https://dev.onenas.atlasflux.my" : "https://onenas.atlasflux.my"
    ...
    function normalizeOidcBaseUrl(): string {
      ...
      if (!value) return "https://onenas.atlasflux.my"
