...
const productName = channel === "prod" ? "ONeNas Code" : `ONeNas Code ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      ONeNas Code is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
  ...
  <url type="homepage">https://onenas.atlasflux.my</url>
