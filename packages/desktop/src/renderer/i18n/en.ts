export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of ONeNas Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of ONeNas Code has been downloaded, would you like to install it and relaunch?",
