export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'ONeNas Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'ONeNas Code a été téléchargée. Voulez-vous l'installer et redémarrer ?",
