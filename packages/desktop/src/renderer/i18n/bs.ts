export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju ONeNas Code-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} ONeNas Code-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
