export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af ONeNas Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af ONeNas Code er blevet downloadet. Vil du installere den og genstarte?",
