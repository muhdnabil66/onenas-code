export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av ONeNas Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av ONeNas Code er lastet ned. Vil du installere den og starte på nytt?",
