export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von ONeNas Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von ONeNas Code wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
