export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji ONeNas Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} ONeNas Code. Czy chcesz ją zainstalować i uruchomić ponownie?",
