export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в ONeNas Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в ONeNas Code.",
  ...
  "dialog.server.description": "Переключите сервер ONeNas Code к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка ONeNas Code в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление ONeNas Code в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите ONeNas Code в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "ONeNas Code готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите ONeNas Code в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в ONeNas Code требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте ONeNas Code.",
  ...
  "toast.update.description": "Новая версия ONeNas Code ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде ONeNas Code",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что ONeNas Code пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер ONeNas Code внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения ONeNas Code",
  ...
  "settings.general.row.appearance.description": "Настройте как ONeNas Code выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли ONeNas Code системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление ONeNas Code.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске ONeNas Code",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию ONeNas Code.",
