export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no ONeNas Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no ONeNas Code.",
  ...
  "dialog.server.description": "Trocar para qual servidor ONeNas Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o ONeNas Code em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o ONeNas Code em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o ONeNas Code em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "O ONeNas Code está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O ONeNas Code está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o ONeNas Code em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o ONeNas Code possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O ONeNas Code não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o ONeNas Code novamente.",
  ...
  "toast.update.description": "Uma nova versão do ONeNas Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do ONeNas Code",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: ONeNas Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor ONeNas Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do ONeNas Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o ONeNas Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o ONeNas Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o ONeNas Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o ONeNas Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do ONeNas Code.",
