...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 ONeNas Code Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "ONeNas Code 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 ONeNas Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "ONeNas Code Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 ONeNas Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 ONeNas Code 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 ONeNas Code 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 ONeNas Code...",
  "wsl.onboarding.updatingOpencode": "正在更新 ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 ONeNas Code...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 ONeNas Code。",
  "wsl.onboarding.updateOpencode": "更新 ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 ONeNas Code 已就绪。",
  "wsl.onboarding.opencodeReady": "ONeNas Code 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 ONeNas Code。",
  "wsl.onboarding.installOpencode": "安装 ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 ONeNas Code",
  ...
  "wsl.onboarding.wslNotInstalled.description": "ONeNas Code 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 ONeNas Code。",
  ...
  "toast.update.description": "ONeNas Code 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 ONeNas Code 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: ONeNas Code 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 ONeNas Code 服务器。",
  ...
  "settings.general.row.language.description": "更改 ONeNas Code 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 ONeNas Code 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 ONeNas Code 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 ONeNas Code 的主题。",
  ...
  "settings.updates.row.startup.description": "在 ONeNas Code 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 ONeNas Code。",
