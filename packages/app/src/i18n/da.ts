export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i ONeNas Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i ONeNas Code.",
  ...
  "dialog.server.description": "Skift hvilken ONeNas Code-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker ONeNas Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer ONeNas Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater ONeNas Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før ONeNas Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter ONeNas Code igen.",
  ...
  "toast.update.description": "En ny version af ONeNas Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til ONeNas Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, ONeNas Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør ONeNas Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for ONeNas Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan ONeNas Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om ONeNas Code følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan ONeNas Code er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når ONeNas Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af ONeNas Code.",
