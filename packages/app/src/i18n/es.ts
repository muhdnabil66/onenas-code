export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en ONeNas Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en ONeNas Code.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de ONeNas Code se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando ONeNas Code en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando ONeNas Code en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza ONeNas Code en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "ONeNas Code está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala ONeNas Code en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que ONeNas Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir ONeNas Code.",
  ...
  "toast.update.description": "Una nueva versión de ONeNas Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de ONeNas Code",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, ONeNas Code no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor ONeNas Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para ONeNas Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve ONeNas Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si ONeNas Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de ONeNas Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia ONeNas Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de ONeNas Code.",
