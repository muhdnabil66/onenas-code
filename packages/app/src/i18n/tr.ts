...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ONeNas Code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve ONeNas Code'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak ONeNas Code'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ONeNas Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi ONeNas Code sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "ONeNas Code kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde ONeNas Code kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "ONeNas Code güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde ONeNas Code güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki ONeNas Code'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "ONeNas Code'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde ONeNas Code hazır.",
  "wsl.onboarding.opencodeReady": "ONeNas Code hazır.",
  "wsl.onboarding.installOpencodeIn": "ONeNas Code'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "ONeNas Code'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ONeNas Code'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından ONeNas Code'u tekrar açın.",
  ...
  "toast.update.description": "ONeNas Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı ONeNas Code ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: ONeNas Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "ONeNas Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "ONeNas Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "ONeNas Code'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "ONeNas Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "ONeNas Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "ONeNas Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "ONeNas Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "ONeNas Code'un en son sürümünü kullanıyorsunuz.",
