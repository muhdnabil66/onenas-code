export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans ONeNas Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans ONeNas Code.",
  ...
  "dialog.server.description": "Changez le serveur ONeNas Code auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'ONeNas Code dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'ONeNas Code dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour ONeNas Code dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "ONeNas Code est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez ONeNas Code dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'ONeNas Code puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez ONeNas Code.",
  ...
  "toast.update.description":
    "Une nouvelle version d'ONeNas Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe ONeNas Code",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'ONeNas Code ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "ONeNas Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur ONeNas Code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour ONeNas Code",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'ONeNas Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si ONeNas Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'ONeNas Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'ONeNas Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'ONeNas Code.",
