export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in ONeNas Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in ONeNas Code.",
  ...
  "dialog.server.description": "Switch which ONeNas Code server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking ONeNas Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating ONeNas Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update ONeNas Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "ONeNas Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install ONeNas Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before ONeNas Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen ONeNas Code.",
  ...
  "toast.update.description": "A new version of ONeNas Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the ONeNas Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, ONeNas Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the ONeNas Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for ONeNas Code",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how ONeNas Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether ONeNas Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how ONeNas Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when ONeNas Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of ONeNas Code.",
