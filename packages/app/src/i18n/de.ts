...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ONeNas Code zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.link": "onenas.atlasflux.my/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in ONeNas Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ONeNas Code zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den ONeNas Code-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "ONeNas Code",
  ...
  "wsl.onboarding.checkingOpencode": "ONeNas Code wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "ONeNas Code in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "ONeNas Code wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "ONeNas Code in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie ONeNas Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "ONeNas Code aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "ONeNas Code ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie ONeNas Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "ONeNas Code installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor ONeNas Code einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann ONeNas Code erneut.",
  ...
  "toast.update.description": "Eine neue Version von ONeNas Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem ONeNas Code-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: ONeNas Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "ONeNas Code Desktop",
  ...
  "settings.desktop.wsl.description": "ONeNas Code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für ONeNas Code ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie ONeNas Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob ONeNas Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von ONeNas Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von ONeNas Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von ONeNas Code.",
