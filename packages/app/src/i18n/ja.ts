export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ONeNas Codeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、ONeNas Codeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してONeNas Codeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、ONeNas Codeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するONeNas Codeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "ONeNas Codeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のONeNas Codeを確認中...",
  "wsl.onboarding.updatingOpencode": "ONeNas Codeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のONeNas Codeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のONeNas Codeを更新してください。",
  "wsl.onboarding.updateOpencode": "ONeNas Codeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のONeNas Codeの準備ができました。",
  "wsl.onboarding.opencodeReady": "ONeNas Codeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にONeNas Codeをインストールしてください。",
  "wsl.onboarding.installOpencode": "ONeNas Codeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Codeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ONeNas CodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、ONeNas Codeをもう一度開いてください。",
  ...
  "toast.update.description": "ONeNas Codeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをONeNas Codeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ONeNas CodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Codeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でONeNas Codeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "ONeNas Codeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのONeNas Codeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "ONeNas Codeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "ONeNas Codeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "ONeNas Code の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "ONeNas Code は最新バージョンです。",
