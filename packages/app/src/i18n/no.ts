...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i ONeNas Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i ONeNas Code.",
  ...
  "dialog.server.description": "Bytt hvilken ONeNas Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av ONeNas Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ONeNas Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at ONeNas Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør ONeNas Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for ONeNas Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan ONeNas Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om ONeNas Code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan ONeNas Code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når ONeNas Code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ONeNas Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker ONeNas Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer ONeNas Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater ONeNas Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "ONeNas Code er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer ONeNas Code i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før ONeNas Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter ONeNas Code på nytt.",
