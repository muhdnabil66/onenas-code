export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u ONeNas Code-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u ONeNas Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u ONeNas Code-u.",
  ...
  "dialog.server.description": "Promijeni na koji se ONeNas Code server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera ONeNas Code u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje ONeNas Code u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj ONeNas Code u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "ONeNas Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj ONeNas Code u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi ONeNas Code mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori ONeNas Code.",
  ...
  "toast.update.description": "Nova verzija ONeNas Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku ONeNas Code timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: ONeNas Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni ONeNas Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u ONeNas Code-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako ONeNas Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li ONeNas Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu ONeNas Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se ONeNas Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju ONeNas Code-a.",
