export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ONeNas Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك ONeNas Code Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في ONeNas Code.",
  ...
  "dialog.server.description": "تبديل خادم ONeNas Code الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من ONeNas Code في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث ONeNas Code في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث ONeNas Code في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "ONeNas Code جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت ONeNas Code في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن ONeNas Code من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على ONeNas Code التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح ONeNas Code.",
  ...
  "toast.update.description": "نسخة جديدة من ONeNas Code ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق ONeNas Code",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن ONeNas Code لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن ONeNas Code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم ONeNas Code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ ONeNas Code",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور ONeNas Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان ONeNas Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة ONeNas Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل ONeNas Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من ONeNas Code.",
