export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez ONeNas Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w ONeNas Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "ONeNas Code Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w ONeNas Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w ONeNas Code.",
  ...
  "dialog.server.description": "Przełącz serwer ONeNas Code, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie ONeNas Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie ONeNas Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie ONeNas Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie ONeNas Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj ONeNas Code w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj ONeNas Code",
  "wsl.onboarding.opencodeReadyIn": "ONeNas Code jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "ONeNas Code jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj ONeNas Code w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj ONeNas Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ONeNas Code nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim ONeNas Code będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "ONeNas Code nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz ONeNas Code.",
  ...
  "toast.update.description": "Nowa wersja ONeNas Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu ONeNas Code",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: ONeNas Code nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "ONeNas Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer ONeNas Code wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla ONeNas Code",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd ONeNas Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy ONeNas Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw ONeNas Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania ONeNas Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji ONeNas Code.",
