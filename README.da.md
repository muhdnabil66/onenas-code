...
brew install anomalyco/tap/onenas # macOS og Linux (anbefalet, altid up to date)
brew install onenas              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
onenas findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/muhdnabil66/onenas-code/releases) eller [onenas.ai/download](https://onenas.atlasflux.my/download).
...
1. `$onenas_INSTALL_DIR` - Tilpasset installationsmappe
...
onenas har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://onenas.atlasflux.my/docs/agents).

### Dokumentation

For mere info om konfiguration af onenas, [**se vores docs**](https://onenas.atlasflux.my/docs).

### Bidrag

Hvis du vil bidrage til onenas, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på onenas

Hvis du arbejder på et projekt der er relateret til onenas og bruger "onenas" som en del af navnet; f.eks. "onenas-dashboard" eller "onenas-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af onenas-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/onenas) | [X.com](https://x.com/onenas)
