...
npm i -g onenas-code@latest        # o bun/pnpm/yarn
scoop install onenas             # Windows
choco install onenas             # Windows
brew install anomalyco/tap/onenas # macOS y Linux (recomendado, siempre al día)
brew install onenas              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S onenas            # Arch Linux (Stable)
paru -S onenas-bin               # Arch Linux (Latest from AUR)
mise use -g onenas               # cualquier sistema
nix run nixpkgs#onenas           # o github:muhdnabil66/onenas-code para la rama dev más reciente
```
...
onenas también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/muhdnabil66/onenas-code/releases) o desde [onenas.ai/download](https://onenas.atlasflux.my/download).
...
1. `$onenas_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.onenas/bin` - Alternativa por defecto
...
onenas incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://onenas.atlasflux.my/docs/agents).

### Documentación

Para más información sobre cómo configurar onenas, [**ve a nuestra documentación**](https://onenas.atlasflux.my/docs).

### Contribuir

Si te interesa contribuir a onenas, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en onenas

Si estás trabajando en un proyecto basado en onenas y usas "onenas" como parte del nombre, por ejemplo, "onenas-dashboard" u "onenas-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de onenas y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/onenas) | [X.com](https://x.com/onenas)
